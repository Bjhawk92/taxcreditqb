  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Your next play. Backed by experience. Playbook, Equipment, Game Plans, and QB Access to help your team read the field and make the case.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Architects+Daughter&family=Barlow+Condensed:wght@500;600;700;800&family=Figtree:ital,wght@0,400;0,500;0,600;1,400&display=swap",
      },
    ],
  }),
