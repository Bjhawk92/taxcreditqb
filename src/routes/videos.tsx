...
export const Route = createFileRoute("/videos")({
  head: () =>
    seo({
      ...
      description:
        "Study the field. Read the defense. Real development situations, presentation strategies, difficult questions, and the decisions that move LIHTC deals forward.",
    }),
  component: Videos,
});
  ...
  return (
    <main id="main">
      <PageHero
        ...
        sub="Review real development situations, presentation strategies, difficult questions, objections, financing issues, municipal challenges, and the decisions that move LIHTC deals forward. Each breakdown helps your team recognize the coverage, anticipate resistance, and prepare the response."
      />
      <section
