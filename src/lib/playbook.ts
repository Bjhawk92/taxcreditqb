export const DECKS = [
  ...
  },
  {
    ...
    job: "Present a clear, site-specific case for the development. Establish the facts, address the opposition’s strongest arguments, and give decision-makers credible reasons to support the project.",
