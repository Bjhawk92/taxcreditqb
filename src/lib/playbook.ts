export const DECKS = [
  {
    ...
    call: "Read the field. Establish your position",
    ...
    job: "Introduce your company, demonstrate your track record, and understand how the municipality views the market, site, housing need, and potential development. Read the field before asking for a formal decision.",
  ...
  },
  {
    ...
    call: "Read the defense. Prepare the response",
    ...
    job: "Introduce the development and your team, uncover the concerns driving neighborhood resistance, and prepare clear responses before those objections reach the formal approval process.",
  ...
  },
  {
    ...
    job: "Present a clear, site-specific case for the development. Establish the facts, address the strongest objections and competing arguments, and give decision-makers credible reasons to support the project.",
